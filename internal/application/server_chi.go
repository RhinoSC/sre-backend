...
func (s *ServerChi) Run() (err error) {
	...
	router.Use(cors.Handler(cors.Options{
		AllowedOrigins: []string{"http://speedrunespanol.com", "https://speedrunespanol.com", "https://*.speedrunespanol.com", "http://*.speedrunespanol.com", "http://localhost:8080", "http://localhost:8081", "http://localhost:3000", "http://localhost:4000"},
