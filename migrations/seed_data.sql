...
('team3', 'Team Gamma'),
('team4', 'Team Delta'),
('team7', 'Equipo nuevo 3'),
('team8', 'Equipo nuevo 4'),
('team9', 'Equipo nuevo 5');
...
('bid5', 'Bid 2', 150, 75, 'Description for Bid 2', 'bidwar', true, 'run4'),
('bid6', 'Bid 3', 200, 100, 'Description for Bid 3', 'total', false, 'run5'),
('bid7', 'Bid 4', 300, 150, 'Description for Bid 4', 'goal', false, 'run6');
...
('schedule3', 'Schedule 3', 1609800000000, 1609886400000, 'event1'),
('schedule4', 'Schedule 4', 1609972800000, 1610059200000, 'event2');
...
('event3', 'Event 3', 1609800000000, 1609886400000),
('event4', 'Event 4', 1609972800000, 1610059200000);
...
DELETE FROM runs WHERE id NOT IN (SELECT run_id FROM teams_runs);
